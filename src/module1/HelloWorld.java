...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(1000, 700, P2D);  // Set up the Applet window to be 800x600
		...
		map1 = new UnfoldingMap(this, 20, 20, 350, 500, provider);
		...
		//create second map
		map2 = new UnfoldingMap(this,400,20,400,400,provider);
	    map2.zoomAndPanTo(zoom2, new Location(4.027097f, 9.701591f));
